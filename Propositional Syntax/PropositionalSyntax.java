...
public class PropositionalSyntax
{
	...
	public static void main(String[] args)
	{
		...
		ArrayList<PropSynUtility.Problem> problems = PropSynUtility.readProblemFile(args[0]);
		int count = 0;
		
		for (PropSynUtility.Problem prob : problems)
		{
			boolean result = evalExpression(prob.expression, prob.values);
